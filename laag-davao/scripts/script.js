document.addEventListener('DOMContentLoaded', function() {
    ...
    const destinations = [
        ...
        },
        {
            ...
            "website": "",
            "level": 1,
            "imageUrl": "https://tourism.davaocity.gov.ph/wp-content/uploads/2022/09/tribe-002.jpg"
        },
    ];
    ...
    // Auto-scroll carousel every 20 seconds
    function autoScrollCarousel() {
        slideIndex++;
        updateCarousel();
    }
    setInterval(autoScrollCarousel, 5000); // 20 seconds interval
